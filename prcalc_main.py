...
class MainWindow(qtw.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.nCComp = 0 # How to declare variables
       
        # self.ui.correctButton.clicked.connect(self.cor) # How to call a function

        # Menubar commands
        # self.ui.actionRestore.triggered.connect(self.restore) # How to call a action, which I think is the top bar buttons.


        #Your code ends here
        self.show() 

    def correctAct(self): #Updates UI
        print('correct!')

    def incorrectAct(self): #Updates UI
        print('incorrect')
